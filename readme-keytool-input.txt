...
Is <CN=MyFirstName MyLastName, OU=MyDevelopmentUnit, O=MyExampleCompany,
  ...
  [no]:  y
Enter key password for <bassstreamplaybackaliaskey> <RETURN if same as keystore password>: 123456

3. Execute "release-keystore.bat" [.sh]
            warning: well, before execute, you can change/edit the [param] -alias bassstreamplaybackaliaskey
              ex.  -alias www.mycompany.com 
              Please, change/edit/Sync [key.alias=bassstreamplaybackaliaskey] "ant.properties" too!

4. Edit [notepad like] "ant.properties" to more representative information!"
        warning: "key.alias=bassstreamplaybackaliaskey" need be the same as in "release-keystore.bat [.sh]"
