...
library controls;  //[by Lamw: Lazarus Android Module Wizard: 2017-09-03 16:16:31]
  
{$mode delphi}
  
uses
  cthreads, Classes, SysUtils, And_jni, And_jni_Bridge, AndroidWidget, Laz_And_Controls,
  Laz_And_Controls_Events, unit1, BASS;
  
{%region /fold 'LAMW generated code'}

{ Class:     org_lamw_bassstreamplayback_Controls
  Method:    pAppOnCreate
...
begin
  ...
  begin
     curEnv:= PJNIEnv(PEnv);
     RegisterNativeMethods(curEnv, 'org/lamw/bassstreamplayback/Controls');
  end;
...
exports
  ...
  pAppOnCreate name 'Java_org_lamw_bassstreamplayback_Controls_pAppOnCreate',
  pAppOnScreenStyle name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pAppOnScreenStyle',
  pAppOnNewIntent name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pAppOnNewIntent',
  pAppOnDestroy name 'Java_org_lamw_bassstreamplayback_Controls_pAppOnDestroy',
  pAppOnPause name 'Java_org_lamw_bassstreamplayback_Controls_pAppOnPause',
  pAppOnRestart name 'Java_org_lamw_bassstreamplayback_Controls_pAppOnRestart',
  pAppOnResume name 'Java_org_lamw_bassstreamplayback_Controls_pAppOnResume',
  pAppOnStart name 'Java_org_lamw_bassstreamplayback_Controls_pAppOnStart',
  pAppOnStop name 'Java_org_lamw_bassstreamplayback_Controls_pAppOnStop',
  pAppOnBackPressed name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pAppOnBackPressed',
  pAppOnRotate name 'Java_org_lamw_bassstreamplayback_Controls_pAppOnRotate',
  pAppOnConfigurationChanged name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pAppOnConfigurationChanged',
  pAppOnActivityResult name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pAppOnActivityResult',
  pAppOnCreateOptionsMenu name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pAppOnCreateOptionsMenu',
  pAppOnClickOptionMenuItem name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pAppOnClickOptionMenuItem',
  pAppOnPrepareOptionsMenu name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pAppOnPrepareOptionsMenu',
  pAppOnPrepareOptionsMenuItem name 'Java_org_lamw_bassstreamplayback_Controls'
    +'_pAppOnPrepareOptionsMenuItem',
  pAppOnCreateContextMenu name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pAppOnCreateContextMenu',
  pAppOnClickContextMenuItem name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pAppOnClickContextMenuItem',
  pOnDraw name 'Java_org_lamw_bassstreamplayback_Controls_pOnDraw',
  pOnTouch name 'Java_org_lamw_bassstreamplayback_Controls_pOnTouch',
  pOnClickGeneric name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pOnClickGeneric',
  pAppOnSpecialKeyDown name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pAppOnSpecialKeyDown',
  pOnClick name 'Java_org_lamw_bassstreamplayback_Controls_pOnClick',
  pOnLongClick name 'Java_org_lamw_bassstreamplayback_Controls_pOnLongClick',
  pOnChange name 'Java_org_lamw_bassstreamplayback_Controls_pOnChange',
  pOnChanged name 'Java_org_lamw_bassstreamplayback_Controls_pOnChanged',
  pOnEnter name 'Java_org_lamw_bassstreamplayback_Controls_pOnEnter',
  pOnClose name 'Java_org_lamw_bassstreamplayback_Controls_pOnClose',
  pAppOnViewClick name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pAppOnViewClick',
  pAppOnListItemClick name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pAppOnListItemClick',
  pOnFlingGestureDetected name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pOnFlingGestureDetected',
  pOnPinchZoomGestureDetected name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pOnPinchZoomGestureDetected',
  pOnLostFocus name 'Java_org_lamw_bassstreamplayback_Controls_pOnLostFocus',
  pOnBeforeDispatchDraw name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pOnBeforeDispatchDraw',
  pOnAfterDispatchDraw name 'Java_org_lamw_bassstreamplayback_Controls_'
    +'pOnAfterDispatchDraw',
  pOnLayouting name 'Java_org_lamw_bassstreamplayback_Controls_pOnLayouting';
...
begin
  ...
  gjAppName:= 'org.lamw.bassstreamplayback';
  gjClassName:= 'org/lamw/bassstreamplayback/Controls';
